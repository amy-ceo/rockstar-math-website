...
exports.registerUser = async (req, res) => {
  try {
    ...
    //     // ✅ Send Welcome Email
    //     try {
    //       const subject = `🎉 Welcome to RockstarMath, ${newUser.username}!`
    //       const htmlContent = `
    ...
    //       <img src="https://your-logo-url.com/logo.png" alt="RockstarMath" style="width: 150px; margin-bottom: 10px;">
...
exports.getArchivedClasses = async (req, res) => {
  try {
    ...
    const user = await Register.findById(userId).select("archivedClasses"); // ✅ Fix: Fetch only archivedClasses
