...
const createPaymentIntent = async () => {
  ...
  try {
      ...
      const response = await fetch("https://frontend-production-90a4.up.railway.app/api/stripe/create-payment-intent", {
        method: "POST",
...
const startCheckout = async () => {
  try {
      ...
      const response = await fetch("https://frontend-production-90a4.up.railway.app/api/create-checkout-session", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
...
const handlePaymentSuccess = async () => {
  try {
    ...
    const response = await fetch("https://frontend-production-90a4.up.railway.app/api/add-purchased-class", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        userId: user._id, // ✅ Fix applied
