   ...
   useEffect(() => {
     ...
     const fetchDashboardData = async () => {
       ...
       try {
         ...
         const classResponse = await fetch(`https://frontend-production-9912.up.railway.app/api/${users._id}/purchased-classes`);
         ...
         const zoomResponse = await fetch(`https://frontend-production-9912.up.railway.app/api/${users._id}/zoom-meeting`);
