   ...
   useEffect(() => {
     ...
     const fetchDashboardData = async () => {
       ...
       try {
         ...
         const classResponse = await fetch(`https://backend-production-cbe2.up.railway.app/api/${users._id}/purchased-classes`);
         ...
         const zoomResponse = await fetch(`https://backend-production-cbe2.up.railway.app/api/${users._id}/zoom-meeting`);
