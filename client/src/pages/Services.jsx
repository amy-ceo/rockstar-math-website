...
const Services = () => {
    ...
    const fetchServices = async () => {
      try {
        const response = await axios.get(
          'https://backend-production-cbe2.up.railway.app/api/stripe/get-products',
        )
  ...
  const categorizedServices = {
    ...
    'Recommended for Student up to Algebra I': services.filter((service) =>
    ...
    'Single Sessions': services.filter((service) =>
      /(\b90 Minute Tutoring Session\b|\b30 Minute Tutoring Session\b|\b60 Minute Tutoring Session\b)/i.test(
        service.name,
      ),
    ),
  }
