...
function StudentFeedback() {
    const reviews = [
        {
            img: "images/feedback_images/1.jpg", // ✅ FIXED PATH (Removed leading "/")
            name: "Alice Johnson",
            class: "Grade 9",
        ...
        {
            img: kid1, // ✅ FIXED PATH (Removed leading "/")
            name: "Josh Hammond",
            class: "FSC",
        ...
        {
            img: kid2, // ✅ FIXED PATH (Removed leading "/")
        ...
        {
            img: "images/feedback_images/4.jpg", // ✅ FIXED PATH
            name: "Daisy Lee",
            class: "FSC",
        ...
        {
            img: "images/feedback_images/5.jpg", // ✅ FIXED PATH
            name: "Ethan Hawke",
            class: "Grade 11",
